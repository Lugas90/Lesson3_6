...
import com.example.lesson3_6.controller.FacultyController;
import com.example.lesson3_6.model.Faculty;
import com.example.lesson3_6.repository.FacultyRepository;
import com.example.lesson3_6.service.FacultyService;
...
public class FacultyControllerTest {
    ...
    public void TestFaculty () throws Exception {
        ...
        Mockito.when(facultyRepository.findFacultyByColor(any(String.class))).thenReturn(Collections.singleton(faculty));
